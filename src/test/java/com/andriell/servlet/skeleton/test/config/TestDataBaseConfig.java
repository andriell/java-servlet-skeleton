...
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://192.168.99.100:3309/spring_test";
    private static final String PROPERTY_NAME_DATABASE_USERNAME = "spring_test";
    private static final String PROPERTY_NAME_DATABASE_PASSWORD = "password";

    private static final String PROPERTY_NAME_HIBERNATE_DIALECT = "org.hibernate.dialect.MySQLDialect";
    private static final String PROPERTY_NAME_HIBERNATE_SHOW_SQL = "true";
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.andriell.servlet.skeleton.entity";
